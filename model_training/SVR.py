...
param_grid_SVR = {'kernel' : ['poly'] , 'degree' : [1] , 'C' : [0.1,1,5,50,100] , 
...
best_model_SVR = grid_search_and_plot_result(param_grid_SVR,SVR(),X_train_tra,y_train,X_test_tra,y_test)
         
#save the best model
save_path = os.path.join('House_Price_Prediction_Advanced_Regression_Techniques_Kaggle','model_pickle','SVR.pkl')
joblib.dump(best_model_SVR,save_path)